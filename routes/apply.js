...
router.post("/apply", function(req, res){
	...
	newUserInstance.save(function(err){
		if(err){
			...
			console.log(err);
			res.send({"error": "An Error Occurred During registration, make sure you're not using the same email address or phone number and make sure to fill all necessary information requested of you."})
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			let mailOptions1 = {
				...
				let mailOptions2 = {
					...
					sendEmailNotification(mailOptions1)
						.then(
							data => {
								console.log(data);
								sendEmailNotification(mailOptions2)
									.then(
										data => {
											return res.send({"success": "Your Account has been created successfully, kindly chck your email for our confirmation message."})
										},
										error => {
											console.log(error);
											return res.send({"error": "Your Account has been created successfully, but there was an error sending your confirmation email."})
										}
									)
							},
							error => {
